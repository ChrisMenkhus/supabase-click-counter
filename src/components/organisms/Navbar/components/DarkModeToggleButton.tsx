...
const DarkModeSwitch = ({
  ...
  return (
    <label
      htmlFor="darktoggle"
      className="relative w-28 h-8 text-white bg-trueGray dark:bg-[#222] rounded-full transition-all hover:scale-105"
    >
      <input
        type="checkbox"
        name="darktoggle"
        ...
        autoComplete="off"
      />
      <span className="flex absolute peer-checked:left-20 w-8 h-8 text-black bg-white rounded-full border-2 border-black transition-all">
